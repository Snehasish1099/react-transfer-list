...
function ItemList({ items, setItems }) {
  // console.log(Array.from(items.entries()))
  return (
...
function hasNoSelectedItems(items) {
  /**
   * In this case, the function (val) => Boolean(val) converts each value val to a boolean. If val is a truthy value (e.g., non-zero number, non-empty string, true, etc.), it will be included in the new array. If val is a falsy value (e.g., 0, false, null, undefined, empty string, etc.), it will be excluded from the new array.
   */
